<?php 
    ...
    $mpdf->SetHTMLHeader('
        <table width="100%" style="text-align:center;" >
            <tr>
                <td style="font-size:20px;font-weight:bold;">Laporan Surat Keterangan Tahun '.$tahun.'</td>
            </tr>
        </table>
    ');
    ...
    $tbl = '<table width="100%" style="font-size:12px;margin-top:5px;margin-bottom:10px;border-collapse:collapse">
        <thead>
            <tr>
                ...
                <th style="text-align:center;border:1px solid grey;">Yang bertanda tangan</th>
                <th style="text-align:center;border:1px solid grey;">Menerangkan kepada</th>
            </tr>
        </thead>
        <tbody>';

        $no = 0;
        $query = mysqli_query($konek, "SELECT a.*, b.nama as nama_guru, c.nama as nama_siswa 
    ...
    while($dt = mysqli_fetch_assoc($query)){
        ...
        $tbl .= '<tr>
          ...
          <td style="text-align:left;border:1px solid grey;padding-left:5px;" width="200px">'.$dt['nomor_surat'].'</td>
          <td style="text-align:left;border:1px solid grey;padding-left:5px;" width="100px">'.$dt['tgl_surat'].'</td>
          <td style="text-align:left;border:1px solid grey;padding-left:5px;" width="100px">'.$dt['nama_guru'].'</td>
          <td style="text-align:left;border:1px solid grey;padding-left:5px;" width="100px">'.$dt['nama_siswa'].'</td>
        </tr>';
    }
