<?php 
    ...
    $mpdf->SetHTMLHeader('
        <table width="100%" style="text-align:center;" >
            <tr>
                <td style="font-size:20px;font-weight:bold;">Laporan Surat Masuk Bulan '.bulan_indo($bulan).'</td>
            </tr>
        </table>
    ');
    ...
    $no = 0;
    $query = mysqli_query($konek, "SELECT * from surat_masuk WHERE DATE_FORMAT(tgl_surat, '%Y-%m') = '$bulan'");
    if (!$query) {
