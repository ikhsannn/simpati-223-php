<?php 
    ...
    $mpdf->SetHTMLHeader('
        <table width="100%" style="text-align:center;" >
            <tr>
                <td style="font-size:20px;font-weight:bold;">Laporan Surat Permohonan Pertahun '.$tahun.'</td>
            </tr>
        </table>
    ');
    ...
    $no = 0;
    $query = mysqli_query($konek, "SELECT * from surat_permohonan WHERE YEAR(tgl_surat) = '$tahun'");
    if (!$query) {
    ...
    while($dt = mysqli_fetch_assoc($query)){
        ...
        $tbl .= '<tr>
          ...
          <td style="text-align:left;border:1px solid grey;padding-left:5px;" width="150px">'.$dt['perihal'].'</td>
        </tr>';
    }
