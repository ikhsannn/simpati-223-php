...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Laporan Surat Permohonan Pertahun</h1>
    </div>
    <div class="row">
                    ...
                    <div class="form-group row justify-content-end">
                        <div class="col-sm-3">
                            <select class="form-control form-control-sm" id="tahun">
                                ...
                                $query = mysqli_query($konek, "SELECT YEAR(tgl_surat) as tahun FROM surat_permohonan GROUP BY YEAR(tgl_surat)");
...
<script>
    function cetak() {
        tahun = $("#tahun").val();
        if (tahun != '') {
            window.open("laporan/laporan_sp_pertahun.php?tahun="+tahun);
        }else{
